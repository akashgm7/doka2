...
import { Users, Store, Factory, Activity, DollarSign, ShoppingBag, Truck, Server, ClipboardList, TrendingUp, ArrowUpRight } from 'lucide-react';
...
const BrandAdminDashboard = () => {
    ...
    const quickActions = [
        { title: 'User Management', desc: 'Manage brand users', path: '/users', icon: Users, color: 'bg-violet-50 text-violet-600', hoverColor: 'hover:border-violet-200' },
        { title: 'Location Management', desc: 'Manage brand outlets', path: '/locations', icon: Store, color: 'bg-primary-50 text-primary-600', hoverColor: 'hover:border-primary-200' },
